module Depict.Internal.Svg.Machine exposing
    ( ToSvgResult
...
import Depict.Internal.Dwg exposing (Dwg(..))
import Depict.Internal.Svg.Defs as Defs
import Depict.Internal.Svg.Env as Env exposing (Env, Warning)
import Depict.Internal.Svg.Event exposing (eventHandlersToSvgAttrs)
import Depict.Internal.Svg.Extras as Extras
import Depict.Internal.Svg.Path as SvgPath
import Depict.Internal.Svg.Style as SvgStyle
import Depict.Math as Math
import Depict.Path as Path exposing (Path)
import Depict.Types as T
    exposing
        ( ContainerSize
        , FrozenName(..)
        , Sizing
